    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
            <h1 class="mt-5">Daftar @if($mhs[0]->strata=='S1') Skripsi @else Thesis @endif {{Session::get('name')}}</h1>
        </div>
        <form class="col-lg-12" role="form" action="{{route('inputskripsi')}}" method="post" enctype="multipart/form-data">
                    ...
                    <table id="revisi" class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <input type="text" id="judul" name="judul" placeholder="" style="width:100%" required> </td>
                            </tr>
                            <tr>
                                <td width="20%">Proposal</td>
                                <td> <input type="file" accept="application/pdf" id="proposal" name="proposal" placeholder="" style="width:100%" required> </td>
                            </tr>
                            <tr>
                            ...
                            @else <input id="penguji2" name="penguji2" value="null" style="width:100%" hidden>
                            @endif
                            <tr>
                                <td width="20%">Tanggal Sidang Proposal</td>
                                <td> <input type="date" id="tanggal" name="tanggal" placeholder="" style="width:100%" required> </td>
                            </tr>
                            <tr>
                                <td width="20%">Jam Sidang Proposal</td>
                                <td> 
