    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
            <h1 class="mt-5">Revisi Sidang Proposal {{Session::get('name')}}</h1>
        </div>
        <form class="col-lg-12" role="form" action="{{route('revisi')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <table id="revisi" class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td width="20%">Revisi Proposal</td>
